...
https://github.com/dc-koromo/hitomi-downloader-2/releases/tag/3.13
...
```
hitomi - downloader, searcher
ex-hentai - downloader
marumaru - downloader (latest update 2018-05-04)
```
...
```
- Downloader -
marumaru - password unlock, captcha unlock
pixiv - downloader (processing)
twitter - media downloader
google community - image downloader
nozomi - image downloader

- Service -
marumaru - ranking, recommend service
```